...
1. [Create an API key](../06-administration/04-api-keys.md) in Administration.
2. Store the key as a CI/CD secret.
3. Add the scanner to your pipeline — see [CI/CD Integrations](../02-inbound/03-cicd-scan.md) for examples.
