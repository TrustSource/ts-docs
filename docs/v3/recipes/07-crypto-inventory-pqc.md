...
1. Enable **Crypto analysis** when scheduling a [deep scan](../02-inbound/05-repository-scans.md).
2. Review the crypto findings in the scan results.
3. Cross-reference with the [Algorithms database](../05-knowledge/05-algorithms.md) for FIPS status.
