...
- **Risk** — an entry in the per-project risk register (separate from CVEs; see the [Risks chapter](../03-internal/05-risks/index.md)).
- **Threat Model** — a STRIDE-classified model attached to a project, generated by an AI agent or imported (see [Threat Models chapter](../03-internal/08-threat-models/index.md)).
