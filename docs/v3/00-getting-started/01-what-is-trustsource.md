...
| Edition | Notes |
|---|---|
| **SaaS (v3)** | The hosted production platform at [app.trustsource.io](https://app.trustsource.io). Documented in this manual. |
| **Community Edition** | An open-source self-hosted edition sharing the platform core. Documented separately in the [CE manual](../../ce/index.md). |

Some features are gated by **license features** that your account admin enables (for example `chat`, `csaf`, `risks`, `threat`, `products`, `sarif`, `medical`). Pages that depend on a license feature will say so at the top. For an overview of optional capabilities, see [Capabilities](../13-capabilities/index.md).
...
- **[Account Types & Editions](02-account-types.md)** — find out exactly what your edition includes.
- **[A 5-Minute Tour](04-quick-tour.md)** — see the app in action.
