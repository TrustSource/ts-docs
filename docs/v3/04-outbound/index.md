...
| Page | What it covers |
|---|---|
| [SBOM + CBOM](01-sbom-cbom.md) | Generate, upload, freeze and download Software and Cryptography Bills of Materials (SPDX, CycloneDX). |
| [Notice Files](02-notice-files.md) | Attribution / open-source notice file generation and maintenance. |
