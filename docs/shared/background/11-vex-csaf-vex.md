...
- [CSAF documents](../v2.16/04-outbound/04-csaf.md) support VEX statements.
- [Post-release monitoring](../v2.16/03-internal/06-approvals/06-post-release-vulnerabilities.md) tracks VEX-relevant changes.
